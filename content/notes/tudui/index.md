...
dir()函数可以看箱子里有什么工具，help()函数告诉我们这个工具怎么用
...
<function is_available at 0x0000021BE0276C10>
>>> torch.cuda.is_available()
False
>>> dir(torch)
